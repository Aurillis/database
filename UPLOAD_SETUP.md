...
3. Name: `report-portal-upload`
4. Expiration: 选最长（1 年）
5. Resource owner: `chenbiyin1770`
6. Repository access: Only select repositories → 勾选 `report-portal`
...
2. Add New Project → 选择导入 `report-portal` 仓库
...
1. 打开 https://chenbiyin1770.github.io/report-portal/
...
- 令牌权限被锁死在 `report-portal` 这一个仓库，动不了你 GitHub 其他东西
